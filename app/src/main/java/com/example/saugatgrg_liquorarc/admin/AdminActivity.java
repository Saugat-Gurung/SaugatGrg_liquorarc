package com.example.saugatgrg_liquorarc.admin;
...
import com.example.saugatgrg_liquorarc.admin.addCategory.ListCategoryActivity;
import com.example.saugatgrg_liquorarc.admin.addProduct.AddProductActivity;
import com.example.saugatgrg_liquorarc.admin.products.ListProductActivity;
import com.example.saugatgrg_liquorarc.api.ApiClient;
import com.example.saugatgrg_liquorarc.api.responses.Dash;
...
import com.example.saugatgrg_liquorarc.utils.PermissionUtils;
...
public class AdminActivity extends AppCompatActivity {
    ...
    ImageView selectedIV, logoutbtn;
    ...
    private void setClickListeners() {
        ...
        logoutbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent userAccount = new Intent(getApplicationContext(), UserAccountActivity.class);
    ...
    private void openAddCategoryView() {
        ...
        View DialogView = factory.inflate(
                R.layout.custom_add_category, null);
