...
import com.example.saugatgrg_liquorarc.api.responses.Slider;
import com.example.saugatgrg_liquorarc.api.responses.SliderResponse;
import com.example.saugatgrg_liquorarc.categoryPage.CategoryActivity;
...
import com.example.saugatgrg_liquorarc.home.fragmets.home.adapters.SliderAdapter;
...
public class    HomeFragment extends Fragment {
    ...
    private void setSliders(List<Slider> sliders) {
        SliderAdapter adapter = new SliderAdapter(sliders, getContext(), false);
    ...
    public void toggleLoading(Boolean toogle) {
        if (toogle)
